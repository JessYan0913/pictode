  ...
  <div class="w-full h-full">
    ...
    >
      ...
      <section class="row-start-1 col-start-2 justify-self-stretch">
        <Tools
          class="pointer-events-auto w-full shadow-md rounded-lg p-2 ring-1 ring-black bg-white dark:bg-slate-800 ring-opacity-5 transition-shadow"
        ></Tools>
      </section>
      <section class="row-start-1 col-start-3 justify-self-end">
        <div
          class="grid grid-flow-col gap-4 items-center w-full pointer-events-auto rounded-lg p-2 ring-1 ring-black bg-white dark:bg-slate-800 ring-opacity-5 transition-shadow"
        >
          ...
          <Select v-model="$i18n.locale">
            ...
            <div
              class="absolute mt-5 mr-10 max-h-60 left-[-30px] w-fit rounded-lg bg-white dark:bg-slate-800 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
            >
              <SelectOption
      ...
      <section class="row-start-2 col-start-3 justify-self-end">
        <PropertyPanel
          class="p-4 w-56 shadow-md rounded-lg ring-1 ring-black bg-white dark:bg-slate-800 ring-opacity-5 transition-shadow pointer-events-auto"
        ></PropertyPanel>
      </section>
      <section class="row-start-3 col-start-1 justify-self-start flex flex-row gap-2">
        <div
          class="grid grid-flow-col gap-2 items-center w-full pointer-events-auto rounded-lg p-2 ring-1 ring-black bg-white dark:bg-slate-800 ring-opacity-5 transition-shadow"
        >
          <Button
    ...
    <div ref="canvasRef" class="w-full h-full dark:bg-slate-800"></div>
  </div>
</template>
